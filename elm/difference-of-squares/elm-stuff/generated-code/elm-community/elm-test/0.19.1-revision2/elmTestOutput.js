...
var $author$project$DifferenceOfSquares$squareOfSum = function (num) {
	return function (x) {
...
var $author$project$DifferenceOfSquares$sumOfSquares = function (num) {
...
var $author$project$DifferenceOfSquares$difference = function (num) {
	return $author$project$DifferenceOfSquares$squareOfSum(num) - $author$project$DifferenceOfSquares$sumOfSquares(num);
};
...
var $author$project$Test$Generated$Main551861852$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/kawamura/Exercism/elm/difference-of-squares/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 383868780431707
	},
...
_Platform_export({'Test':{'Generated':{'Main551861852':{'init':$author$project$Test$Generated$Main551861852$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-32497.sock";
